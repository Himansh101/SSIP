        ...
        <Box m="20px">
          ...
          >
            ...
            {[ 
              ...
              <Box key={index} gridColumn="span 3" backgroundColor={colors.primary[400]} display="flex" alignItems="center" justifyContent="center">
                <StatBox {...item} />
              </Box>
            ))}
            ...
            {/* ROW 3 - Campaign, Sales, and Geography */}
